...
│  │  │        ↓                                                   │  │   │
│  │  │  4.8 人群场景词推断 (LLM) ← 推断消费者搜索词 ⭐ ──────────→│  │   │
│  │  │        ↓                                                   │  │   │
│  │  │  4.9 关键词组合 (LLM) ← 五种组合模式 ──────────────────→│  │   │
│  │  │        ↓                                                   │  │   │
│  │  │  4.10 结果组装 ────────────────────────────────────────→   │  │   │
│  │  │        ↓                                                   │  │   │
...
| scenario_audience_inference | `nodes/scenario_audience_inference_node.py` | agent | **推断消费者搜索人群词/场景词** | `config/scenario_audience_inference_llm_cfg.json` |
| keyword_combination | `nodes/keyword_combination_node.py` | agent | **组合关键词（品牌同款/特征组合/场景/人群/功能）** | `config/keyword_combination_llm_cfg.json` |
...
| `config/scenario_audience_inference_llm_cfg.json` | **人群场景词推断** | **调整场景词/人群词推断规则** |
| `config/keyword_combination_llm_cfg.json` | **关键词组合** | **调整组合策略（五种组合模式）** |
...
- 大语言模型技能：`data_integration`, `product_object_extraction`, `invention_point_extraction`, `keyword_extraction`, `invention_point_refinement`, `keyword_filtering`, `keyword_combination`
