...
class ClaimCompareResult(Base):
    ...
    similarity_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    score_band: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    feature_full_score: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    feature_awarded_score: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    feature_effective_length: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    matched_effective_length: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    claim_total_effective_length: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    zeroed_by_mismatch: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    ...
    token_units: Mapped[Optional[list]] = mapped_column(JSON, nullable=True)
    raw_payload: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    created_at: Mapped[datetime.datetime] = mapped_column(DateTime(True), server_default=text("now()"))
