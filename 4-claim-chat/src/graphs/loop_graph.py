...
from graphs.nodes.review_analysis_node import review_analysis_node
...
class LoopState(BaseModel):
    ...
    reviewed_analysis: List[Dict[str, Any]] = Field(default=[], description="规则审查后的分析结果")
...
# 添加边：分析 → 规则审查 → 规则计分 → 结束
builder.add_edge("analyze_features", "review_analysis")
builder.add_edge("review_analysis", "apply_rules")
